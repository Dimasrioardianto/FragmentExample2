package id.ac.polbeng.ardianto.fragmentexample2
...
import id.ac.polbeng.ardianto.fragmentexample2.databinding.BookDescriptionsBinding

class BookDescription : Fragment() {
    private var _binding: BookDescriptionsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = BookDescriptionsBinding.inflate(inflater, container, false)
